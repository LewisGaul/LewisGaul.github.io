$(function() {
    ...
    $("#comment-form").submit(function() {
        ...
        success: function(data) {
            ...
            showAlert(
                '<strong>Thanks for your comment!</strong><br>It is <a href="https://github.com/LewisGaul/LewisGaul.github.io/pulls">currently pending</a> and will show on the site once approved.'
            );
        },
        error: function(err) {
            console.log(err);
            ...
            .addClass("danger");
            showAlert(
                "<strong>Sorry, there was an error submitting your comment.</strong><br>Please make sure all required fields are filled in. If problems persist please contact the site owner."
            );
